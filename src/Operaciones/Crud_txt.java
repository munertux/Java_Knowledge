...
public class Crud_txt {
    ...
    public List<Inventario> leer_Inventario_U() {
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                lista.add(new Inventario(bloques[0], bloques[1], bloques[2],bloques[3], bloques[4], bloques[5],bloques[6], bloques[7], bloques[8],bloques[9], bloques[10], bloques[11],bloques[12], bloques[13], bloques[14],bloques[15], bloques[16], bloques[17]));
    ...
    public void Agregar_Inventario_U(String marca, String modelo, String f_fabricacion, String placa, String transmision, String combustible, String cilindraje, String abs, String sensor, String AireA, String vidriosEl, String PantTac, String direccion, String EspEle, String velmax, String kilometraje, String Imagen, String precio) {
        ...
        String textToAppend = marca+"\t"+modelo+"\t"+f_fabricacion+"\t"+placa+"\t"+transmision+"\t"+combustible+"\t"+cilindraje+"\t"+abs+"\t"+sensor+"\t"+AireA+"\t"+vidriosEl+"\t"+PantTac+"\t"+direccion+"\t"+EspEle+"\t"+velmax+"\t"+kilometraje+"\t"+Imagen+"\t"+precio+"\n"; // Texto para agregar
    ...
    public List<Credenciales> leer_Login_U() {
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                String[] bloques = linea.split("\t");
                lista.add(new Credenciales(bloques[0], bloques[1], bloques[2]));
